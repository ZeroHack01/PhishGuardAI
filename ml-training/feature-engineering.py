...
class PhishingFeatureExtractor:
    ...
    def extract_url_features(self, url):
        ...
        try:
            ...
            features['is_trusted_domain'] = 1 if extracted.registered_domain in self.trusted_domains else 0
    ...
    def extract_content_features(self, url):
        ...
        try:
            ...
            if response.status_code == 200 and 'text/html' in content_type:
                ...
                # Form analysis (critical for phishing detection)
                ...
                # External form actions (major red flag)
                external_forms = 0
                for form in forms:
                ...
                features.update({
                    ...
                    'has_password_field': 0, 'external_form_count': 0,
                    'external_link_count': 0, 'text_length': 0,
                    'phishing_keyword_count': 0, 'brand_impersonation_score': 0
                })
